...
var PMBOK_CATALOG = [
  { id:'P1', name:'إعداد ميثاق المشروع', group:'بدء', groupEn:'Initiating', tier:2, icon:'📋', desc:'إنشاء وثيقة رسمية تُ Grant صلاحيات رسمية لمدير المشروع وتحدد الأهداف الرئيسية والمتطلبات الأولية للمشروع', inputs:['طلب تقديم الخدمة','دراسة الجدوى الأولية','اتفاقية الشراكة','عقد المشاركة'], outputs:['ميثاق المشروع','سجل أصحاب المصلحة الأولي'], construction:'إعداد ميثاق مشروع بناء يشمل وصف المشروع وأهدافه وميزانيته الأولية وصلاحيات مدير المشروع перед العميل والمقاولين' },
  ...
  { id:'P14', name:'تقدير التكاليف', group:'تخطيط', groupEn:'Planning', tier:1, icon:'💲', desc:'تقدير التكاليف المالية للموارد اللازمة لإنجاز أنشطة المشروع مع مراعاة التضخم والمخاطر', inputs:['سجل الأنشطة','سجل الموارد','معدلات السوق'], outputs:['تقديرات التكاليف الأساسي'], construction:'تقدير تكاليف المواد الإنشائية والعمالة والمعدات والمSubcontractors لكل بند من بنود المشروع' },
  { id:'P15', name:'تحديد الميزانية', group:'تخطيط', groupEn:'Planning', tier:2, icon:'🏦', desc:'تجميع تقديرات التكاليف لإنشاء نموذج لتمويل و掌控 الميزانية الرسمية للمشروع', inputs:['تقديرات التكاليف','جدول الزمني','هيكل تفكيك العمل'], outputs:['基准线 الميزانية','متطلبات التمويل'], construction:'وضع الميزانية الإجمالية لمشروع البناء وتوزيعها على المراحل والبنود مع تحديد السيولة والتدفق المالي' },
  { id:'P16', name:'وضع خطة إدارة الجودة', group:'خطط', groupEn:'Planning', tier:2, icon:'✅', desc:'تحديد معايير الجودة المطلوبة للمشروع وكيفية تحقيقها والتحقق منها والتوثيق', inputs:['خطة إدارة المشروع','بيان النطاق'], outputs:['خطة إدارة الجودة'], construction:'وضع معايير الجودة الإنشائية وطرق الفحص والاختبار والتحقق من مطابقة الأعمال للمواصفات والمعايير' },
  ...
  { id:'P19', name:'وضع خطة إدارة الاتصالات', group:'تخطيط', groupEn:'Planning', tier:2, icon:'📢', desc:'تحديد كيفية تخطيط وتنفيذ و管控 واستمرارية الاتصالات بين جميع الأطراف المعنية', inputs:['خطة إدارة المشروع','سجل أصحاب المصلحة'], outputs:['خطة إدارة الاتصالات'], construction:'وضع نظام الاتصالات للمشروع يشمل الاجتماعات الدورية والتقارير اليومية والتواصل مع العميل والجهات الحكومية' },
  ...
  { id:'P27', name:'توجيه وإدارة العمل', group:'تنفيذ', groupEn:'Executing', tier:2, icon:'🏗️', desc:'تنفيذ العمل المخطط له في وثائق خطة إدارة المشروع وتسجيل بيانات الأداء الفعلية', inputs:['خطة إدارة المشروع','بيانات الأداء'], outputs:[' Deliverables','بيانات أداء العمل'], construction:'تنسيق وإدارة الأعمال الإنشائية الفعلية في الموقع وفقاً للخطط المعتمدة والمواصفات الفنية' },
  ...
  { id:'P29', name:'إدارة الجودة', group:'تنفيذ', groupEn:'Executing', tier:1, icon:'🏅', desc:'تنفيد أنشطة الجودة المخططة لضمان أن العمل مكتمل بالشكل الصحيح مع الحد من الأخطاء', inputs:['خطة إدارة الجودة','بيانات الأداء'], outputs:['تقارير الفحص','تغييرات جودة'], construction:'تنفيذ فحوصات الجودة الإنشائية واختبارات الخرسانة والصلب والwright والتشطيبات وتوثيق النتائج' },
  ...
  { id:'P33', name:'إدارة الاتصالات', group:'تنفيذ', groupEn:'Executing', tier:2, icon:'💬', desc:'إنشاء وجمع وتوزيع وتخزين المعلومات relacionada بالمشروع للأطراف المناسبة في الوقت المناسب', inputs:['خطة إدارة الاتصالات','بيانات الأداء'], outputs:['سجلات الاتصالات','تقارير دورية'], construction:'إدارة اتصالات الموقع اليومية: الاجتماعات الأسبوعية والتقارير اليومية والتواصل مع العميل والموردين' },
  ...
  { id:'P40', name:'التحكم في التكاليف', group:'متابعة وتحكم', groupEn:'Monitoring & Controlling', tier:2, icon:'💶', desc:'مراقبة حالة المشروع وتأكيد التغييرات على الميزانية الأساسية وتطبيق الإجراءات التصحيحية', inputs:['基准线 الميزانية','بيانات الأداء'], outputs:['طلب التغيير','تقديرات التكاليف المحدّثة'], construction:'مراقبة نفقات المشروع الإنشائي مقارنة بالميزانية واتخاذ إجراءات للتحكم في تجاوزات التكلفة' },
  ...
  filterGroup: function(group, btn) {
    ...
    PMBOK_GROUPS.forEach(function(g) {
      ...
      groupProcs.forEach(function(p) {
        ...
        h += '<div class="list-item" style="cursor:pointer;flex-wrap:wrap;" onclick="openProcessDetail(\'' + p.id + '\')">' +
          '<div class="info">' +
